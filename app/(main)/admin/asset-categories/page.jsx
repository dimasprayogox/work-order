// app/(main)/admin/asset-categories/page.jsx
"use client";
...
import AssetCategoryFormDialog from "./components/AssetCategoryFormDialog";
...
const AssetCategoryPage = () => {
    ...
    const [fileName, setFileName] = useState("Asset_Categories");
    ...
    const [columnOptions] = useState([
        { field: 'name', header: 'Category Name', visible: true },
        { field: 'description', header: 'Description', visible: true },
        { field: 'assets_count', header: 'Assets Count', visible: true },
    ...
    const fetchCategories = useCallback(async () => {
        ...
        try {
            ...
            showToast("error", "Error", "Gagal mengambil data kategori aset");
        } finally {
            setLoading(false);
        }
    }, [showToast]);
    ...
    const exportExcel = async () => {
        ...
        const worksheet = workbook.addWorksheet('Asset Categories');
        ...
        categories.forEach(category => {
            const rowData = columnOptions
                ...
                .map(col => {
                    ...
                    } else if (col.field === 'assets_count') {
    ...
    const exportPdf = (config = null) => {
        ...
        doc.text('Asset Categories Report', currentConfig.marginLeft, currentConfig.marginTop);
        ...
        <div className="p-4">
            ...
            <div className="card">
                <div className="flex justify-content-between items-start mb-4">
                    <div>
                        <h3 className="text-2xl font-semibold">Asset Category Management</h3>
                        <p className="text-sm text-gray-500">Manage asset category data in the system.</p>
                    </div>
                </div>
