                        ...
                        <div className="grid">
                            <div className="col-12 md:col-4">
                                <div className="mt-3">
                                    ...
                                    <Dropdown options={["open", "close"]} className="w-full mt-2" />
                                </div>
                                <div className="mt-3">
                                    <label htmlFor="">Maintenance Type</label>
                                    <Dropdown options={["maintenance", "repair", "inspection", "installation"]} className="w-full mt-2" />
                                </div>
                                <div className="mt-3">
                                    <label htmlFor="">Priority</label>
                                    <Dropdown options={["low", "medium", "high", "critical"]} className="w-full mt-2" />
                                </div>
                            </div>
                            <div className="col-12 md:col-4">
                                <div className="mt-3">
                                    <label htmlFor="">Asset</label>
                                    <Dropdown options={["Forklift #1", "Forklift #2", "Forklift #3", "Forklift #4", "Forklift #5"]} className="w-full mt-2" />
                                </div>
                                <div className="mt-3">
                                    <label htmlFor="">Project</label>
                                    <Dropdown options={["Project #1", "Project #2", "Project #3", "Project #4", "Project #5"]} className="w-full mt-2" />
                                </div>
                                <div className="mt-3">
                                    <label htmlFor="">Suggested Start Date</label>
                                    <Calendar className="w-full mt-2" showIcon />
